...
brew install --formula tree git htop btop tmux ctags fzf telnet mosh vim nmap mczachurski/wallpapper/wallpapper git-lfs ripgrep neovim npm lazygit diff-so-fancy fish gh mole fd yazi imagemagick-full chezmoi netwatch iperf3 mtr node wget poppler
